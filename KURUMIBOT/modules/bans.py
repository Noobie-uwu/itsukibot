...
def ban(update: Update, context: CallbackContext) -> str:
    ...
    if is_user_ban_protected(chat, user_id, member) and user not in DEV_USERS:
        if user_id == OWNER_ID:
            message.reply_text("I don't really wanna ban this poor noob guy.")
        elif user_id in DEV_USERS:
            message.reply_text("I can't act against our own.")
        elif user_id in DRAGONS:
            message.reply_text(
                "Fighting this S-Class here will put civilian lives at risk."
            )
        elif user_id in DEMONS:
            message.reply_text(
                "Bring an order from Ratatoskr to fight this A-Class."
            )
        elif user_id in TIGERS:
            message.reply_text(
                "I Can't Ban this guy\nuff he is a B-Class."
            )
        elif user_id in WOLVES:
            message.reply_text("C-Class abilities make them ban immune!")
        else:
